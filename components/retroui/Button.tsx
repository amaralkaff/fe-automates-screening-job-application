...
const buttonVariants = cva(
  "font-head transition-all rounded outline-hidden cursor-pointer duration-200 font-medium flex items-center",
  {
    variants: {
      ...
      size: {
        sm: "px-3 py-1 text-sm shadow hover:shadow-none justify-start text-left",
        md: "px-4 py-1.5 text-base justify-center text-center",
        lg: "px-6 lg:px-8 py-2 lg:py-3 text-md lg:text-lg justify-center text-center",
        icon: "p-2",
      },
    },
    defaultVariants: {
