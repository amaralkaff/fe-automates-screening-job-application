    ...
    <div className="space-y-6">
      ...
      <div className="grid md:grid-cols-2 gap-6">
              ...
              {cvFile ? (
                <div className="flex items-center justify-between p-4 border rounded-lg bg-green-50 border-green-200">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <p className="font-medium text-green-900">{cvFile.preview}</p>
                ...
                <div
                  ...
                  className={`border-2 border-dashed rounded-lg p-6 text-center cursor-pointer transition-colors min-h-[180px] flex flex-col justify-center items-center
        ...
        <Card>
          <Card.Content className="p-6">
            <div className="space-y-4">
              <Label htmlFor="project-upload" className="text-base font-semibold">
                Project Report *
                <span className="text-sm font-normal text-muted-foreground ml-2">
                  (PDF format, max 5MB)
                </span>
              ...
              {projectFile ? (
                <div className="flex items-center justify-between p-4 border rounded-lg bg-green-50 border-green-200">
                  <div className="flex items-center space-x-3">
                    <CheckCircle className="h-5 w-5 text-green-600" />
                    <div>
                      <p className="font-medium text-green-900">{projectFile.preview}</p>
                      <p className="text-sm text-green-700">
